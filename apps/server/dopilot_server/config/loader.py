...
_INT_OVERRIDES: tuple[tuple[str, str, str], ...] = (
    ...
    ("DOPILOT_LOG_MAX_TOTAL_BYTES", "logs", "max_total_bytes"),
    ("DOPILOT_REDIS_STREAM_MAX_BYTES_LOGS", "redis", "stream_max_bytes_logs"),
    ("DOPILOT_REDIS_STREAM_GUARD_INTERVAL_SECONDS", "redis", "stream_guard_interval_seconds"),
    ("DOPILOT_REDIS_SENT_RECONCILE_INTERVAL_SECONDS", "redis",
    ...
    ("DOPILOT_MAINTENANCE_STALE_COMMAND_STREAM_DAYS", "maintenance",
     "stale_command_stream_days"),
    ("DOPILOT_MAINTENANCE_NOTIFICATION_RETENTION_DAYS", "maintenance",
     "notification_retention_days"),
    ("DOPILOT_MAINTENANCE_NOTIFICATION_UNREAD_MAX_DAYS", "maintenance",
     "notification_unread_max_days"),
    ("DOPILOT_MAINTENANCE_NOTIFICATION_MAX_ROWS", "maintenance", "notification_max_rows"),
