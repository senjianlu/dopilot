"""Thin async Redis Streams client wrapper (agent side).
...
top-level ``redis`` library, not this ``dopilot_agent.redis`` package.
"""
...
def build_redis(url: str) -> RedisStreams:
    """Build an agent Redis Streams client from a connection URL."""
