...
def load_settings(
    ...
    *,
    ...
    for env_var, section, key in (
        ...
        ("DOPILOT_AGENT_LOG_FLOOD_KILL_AFTER_SECONDS", agent_section,
         "log_flood_kill_after_seconds"),
        ("DOPILOT_AGENT_JANITOR_QUIET_SECONDS", agent_section,
         "janitor_quiet_seconds"),
        ("DOPILOT_REDIS_LOG_PUBLISH_RATE_BYTES_PER_SECOND", redis_section,
         "log_publish_rate_bytes_per_second"),
